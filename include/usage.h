...
#define bootchartd_full_usage "\n\n" \
       "Create /data/bootchart.tgz with boot chart data\n" \
...
#define last_full_usage "\n\n" \
	...
	IF_FEATURE_LAST_FANCY( "\n" \
     ...
     "\n	-f FILE Read from FILE instead of /data/wtmp" \
	) \
...
#define modprobe_notes_usage \
	...
	"\n" \
	"/system/etc/modules.conf entry format:\n" \
	"\n" \
...
#define syslogd_full_usage "\n\n" \
	...
	IF_FEATURE_KMSG_SYSLOG( \
     ...
     "\n	-O FILE		Log to FILE (default:/data/messages, stdout if -)" \
