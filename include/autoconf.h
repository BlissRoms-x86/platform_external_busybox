 ...
 * Busybox version: 1.24.1-oi
 */
#define AUTOCONF_TIMESTAMP "2018-11-14 15:15:39 AEDT"
...
#define CONFIG_CROSS_COMPILER_PREFIX "/home/annitb/android-ndk-r10e/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-"
...
#define CONFIG_SYSROOT "/home/annitb/android-ndk-r10e/platforms/android-19/arch-arm"
...
#define CONFIG_EXTRA_CFLAGS "-DANDROID -D__ANDROID__ -DSK_RELEASE -nostdlib -march=armv5te -msoft-float -mfloat-abi=softfp -mfpu=vfp -mthumb -mthumb-interwork -fpic -fno-short-enums -fgcse-after-reload -frename-registers "
...
#define CONFIG_EXTRA_LDFLAGS "-Xlinker -z -Xlinker muldefs -nostdlib -Bdynamic -Xlinker -dynamic-linker -Xlinker /system/bin/linker -Xlinker -z -Xlinker nocopyreloc -Xlinker --no-undefined ${SYSROOT}/usr/lib/crtbegin_dynamic.o ${SYSROOT}/usr/lib/crtend_android.o -fuse-ld=bfd "
...
#define CONFIG_LAST_SYSTEM_ID 60000
...
#define CONFIG_IFUPDOWN_IFSTATE_PATH "/data/ifstate"
...
#define CONFIG_FEATURE_IP_ROUTE_DIR "/system/etc/iproute2"
...
#define CONFIG_DHCPD_LEASES_FILE "/data/udhcpd.leases"
...
#define CONFIG_UDHCPC_DEFAULT_SCRIPT "/system/etc/udhcpc/default.script"
...
#endif
#define IF_NOT_SV(...)
#define CONFIG_SV_DEFAULT_SERVICE_DIR "/system/etc/service"
